...
function findWasmBinary() {
  return locateFile("gst-validate-wasm-1.0.wasm");
}
...
var ASM_CONSTS = {
  ...
  12512564: ($0, $1) => {
    console.error("sync_bus_handler depth=" + $0 + " element=" + UTF8ToString($1));
  },
  12512648: () => (typeof document !== "undefined" && typeof OffscreenCanvas !== "undefined") ? 1 : 0,
  12512744: ($0, $1) => {
  ...
  12514069: () => GLctx.drawingBufferWidth,
  12514106: () => GLctx.drawingBufferHeight,
  12514144: $0 => {
