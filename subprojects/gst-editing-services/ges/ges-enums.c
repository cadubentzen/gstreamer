...
static GEnumValue vpattern_enum_values[] = {
  ...
  ,
  {GES_VIDEO_TEST_PATTERN_CHECKERS8, "GES_VIDEO_TEST_PATTERN_CHECKERS8",
      "checkers-8"},
  {GES_VIDEO_TEST_PATTERN_CIRCULAR, "GES_VIDEO_TEST_PATTERN_CIRCULAR",
      "circular"},
  ...
  ,
  {GES_VIDEO_TEST_PATTERN_BALL, "GES_VIDEO_TEST_PATTERN_BALL", "ball"},
  {GES_VIDEO_TEST_PATTERN_SMPTE100, "GES_VIDEO_TEST_PATTERN_SMPTE100",
      "smpte100"},
  {GES_VIDEO_TEST_PATTERN_BAR, "GES_VIDEO_TEST_PATTERN_BAR", "bar"},
  {GES_VIDEO_TEST_PATTERN_PINWHEEL, "GES_VIDEO_TEST_PATTERN_PINWHEEL",
      "pinwheel"},
  {GES_VIDEO_TEST_PATTERN_SPOKES, "GES_VIDEO_TEST_PATTERN_SPOKES", "spokes"},
  {GES_VIDEO_TEST_PATTERN_GRADIENT, "GES_VIDEO_TEST_PATTERN_GRADIENT",
      "gradient"},
  {GES_VIDEO_TEST_PATTERN_COLORS, "GES_VIDEO_TEST_PATTERN_COLORS", "colors"},
  {0, NULL, NULL}
};
