...
typedef enum
{
  ...
  GST_PLAY_TRICK_MODE_DEFAULT = (1 << 0),
  GST_PLAY_TRICK_MODE_DEFAULT_NO_AUDIO = (1 << 1),
  GST_PLAY_TRICK_MODE_KEY_UNITS = (1 << 2),
  GST_PLAY_TRICK_MODE_KEY_UNITS_NO_AUDIO = (1 << 3),
  GST_PLAY_TRICK_MODE_INSTANT_RATE = (1 << 4),
  GST_PLAY_TRICK_MODE_LAST = (1 << 16)
} GstPlayTrickMode;
  ...
  switch (key) {
    ...
    case 'y':
      ...
      if (self->priv->jkl_mode) {
        gst_validate_printr ("JKL shuttle mode enabled");
        self->priv->trick_mode = GST_PLAY_TRICK_MODE_DEFAULT;
      } else {
        gst_validate_printr ("JKL shuttle mode disabled");
