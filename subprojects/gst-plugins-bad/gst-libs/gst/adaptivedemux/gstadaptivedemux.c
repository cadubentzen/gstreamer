...
static void gst_adaptive_demux_class_init (GstAdaptiveDemuxClass * klass, gpointer class_data G_GNUC_UNUSED);
...
static void
gst_adaptive_demux_class_init (GstAdaptiveDemuxClass * klass, gpointer class_data G_GNUC_UNUSED)
{
