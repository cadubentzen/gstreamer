...
static void gst_base_sink_class_init (GstBaseSinkClass * klass, gpointer class_data G_GNUC_UNUSED);
...
static void
gst_base_sink_class_init (GstBaseSinkClass * klass, gpointer class_data G_GNUC_UNUSED)
{
